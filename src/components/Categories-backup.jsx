        ...
        <Row className="text-center">
          ...
          <Col sm={12} md={4}>
            <Card sm={12} md={4} style={{ backgroundColor: '#ffffff66'}}>
              <Card.Img variant="top" src="/images/Screenshot 2023-05-16 at 10.07.49 AM.png" />
              <Card.Body>
          ...
          <Col sm={12} md={4}>
          <Card sm={12} md={4} style={{ backgroundColor: '#ffffff66'}}>
              <Card.Img variant="top" src="/images/Tudors.webp" />
              <Card.Body>
                <Card.Title>Tudors</Card.Title>
                <Card.Text>
                {!tudors
              ? "loading"
              : tudors.map((tudor) => (
          ...
          <Card sm={12} md={4} style={{ backgroundColor: '#ffffff66'}}>
              ...
              <Card.Body>
                <Card.Title>Female Leaders</Card.Title>
                <Card.Text>
                {!femaleLeaders
              ? "loading"
